...
HD_PWD='C:/Users/yoon/xilinx/project_3_full/project_3_full.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_clk_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_clk_div.tcl
