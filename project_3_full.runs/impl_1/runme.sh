...
HD_PWD='C:/Users/yoon/xilinx/project_3_full/project_3_full.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_clk_div.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_clk_div.tcl -notrace
